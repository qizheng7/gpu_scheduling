...
int ptxinfo_parse (void *YYPARSE_PARAM);
#else
int ptxinfo_parse ();
#endif
#else /* ! YYPARSE_PARAM */
...
static const char *const yytname[] =
{
  ...
  "line", "line_info", "function_name", "function_info", "info", "tuple", YY_NULL
};
#endif
